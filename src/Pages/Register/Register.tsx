...
const Register = () => {
    ...
    const [isResidentChecked, setIsResidentChecked] = useState(false);
    const [isGraduatedChecked, setIsGraduatedChecked] = useState(false);
    ...
    const handleFormat = () => {
        ...
        if (birth_date.trim()) {
            ...
            return {
                ...
                academic_index: form.academic_index
                    .replace(/,/g, '.')
                    .replace('_', ''),
            };
        }
